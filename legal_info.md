...
This Terms of Service Agreement (the "Agreement") is entered into between [Dariel Cruz Rodriguez](dariel.us) ("Bot Owner") and the user ("User") of the UChiVerify Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of Chicago, Cook County, Illinois, and the United States of America. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of [Your arbitration provider].
...
- Application refers to UChiVerify, the software program provided by the Company.
- Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to UChiVerify.
